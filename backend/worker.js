// ============================================================
// HubertStudios License Manager — Cloudflare Worker
// Paste the ENTIRE contents of this file into the Cloudflare
// Worker editor (Workers & Pages → your worker → Edit Code).
//
// REQUIRED SECRETS (Settings → Variables and Bindings → Secret):
//   ADMIN_EMAIL, ADMIN_PASSWORD_HASH, ADMIN_PASSWORD_SALT
//   SESSION_SECRET, PRIVATE_KEY
//   EMAIL_API_KEY, EMAIL_FROM
//   TURNSTILE_SECRET_KEY
//   DASHBOARD_ORIGIN  ← must be: https://hubert-studios.vercel.app
//
// REQUIRED BINDINGS:
//   D1 → variable name: DB
//   KV → variable name: KV
